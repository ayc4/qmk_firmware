 ...
 * `-----------------------------------------/      /     \      \------------------------------------------'
 *            | LCTR | LGUI | LAlt |LOWER |/Space /        \Space \ |RAISE | RCTR | RAlt | Print |
 *            `---------------------------------'           '------''---------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,      TG(2),  KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
            KC_LCTRL, KC_LGUI, KC_LALT, KC_LOWER, KC_SPC,           KC_SPC, KC_RAISE, KC_RCTRL, KC_RALT, KC_PSCR \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
static void print_status_narrow(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        case _QWERTY:
            ...
            break;
        case _RAISE:
            oled_write_ln_P(PSTR(" RCE"), false);
            break;
        case _LOWER:
